...
(Make sure to include a README.md file with a brief description of the project and instructions to install and run locally. 
...
Currently, the Flask site only inputs data from three cities: Mesa,AZ, Pittsburgh, PA, and ____. 
